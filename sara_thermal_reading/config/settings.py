...
class Settings(BaseSettings):
    ...
    CONFIDENCE_CALC_LINEAR_MIN_PHASE_CORRELATION: float = Field(
        default=0.03
    )  # 0% Confidence below this
    CONFIDENCE_CALC_LINEAR_MAX_PHASE_CORRELATION: float = Field(
        default=0.1
    )  # 100% Confidence above this
